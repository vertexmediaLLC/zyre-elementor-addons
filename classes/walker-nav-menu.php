...
class Zyre_Walker_Nav_Menu extends \Walker_Nav_Menu {
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
		...
		// Add a submenu indicator if the menu item has children.
		$submenu_indicator = '';
		if ( in_array( 'menu-item-has-children', $classes, true ) ) {
			$submenu_indicator .= '<span class="submenu-indicator"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="14" height="14" x="0" y="0" viewBox="0 0 32 32" xml:space="preserve"><g><path d="M16 24c-.486 0-.974-.177-1.356-.53l-13-12c-.807-.744-.858-2.02-.114-2.827s2.02-.857 2.826-.113L16 19.278 27.644 8.53a2 2 0 1 1 2.713 2.94l-13 12c-.383.353-.87.53-1.357.53z"></path></g></svg></span>';
		}
		...
		$item_output .= ! empty( $menu_item->description ) ? '<span class="menu-item-description">' . esc_html( $menu_item->description ) . '</span>' : '';
		$item_output .= '</a>';
