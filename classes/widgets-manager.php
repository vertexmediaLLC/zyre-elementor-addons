...
class Widgets_Manager {
	...
	public static function get_the_styles_notice( string $widget_id ) {
		return sprintf(
			...
			esc_url( admin_url( 'admin.php?page=zyreladdons&t=widgets&widget=' . $widget_id ) )
		);
	}
	...
	public static function get_free_widgets_map() {
		return [
			...
			'image-carousel'  => [
				...
				'doc'       => 'https://zyreaddons.com/docs/zyre-elementor-addons/widgets/image-carousel/',
			...
			'social-icon'  => [
				...
				'doc'       => 'https://zyreaddons.com/docs/zyre-elementor-addons/widgets/social-icon/',
			...
			'site-title'  => [
				...
				'doc'       => 'https://zyreaddons.com/docs/zyre-elementor-addons/theme-builder/site-title/',
			...
			'menu'  => [
				...
				'doc'       => 'https://zyreaddons.com/docs/zyre-elementor-addons/theme-builder/navigation-menu/',
				'title'     => esc_html__( 'Navigation Menu', 'zyre-elementor-addons' ),
			...
			'lottie-animation'  => [
				...
				'doc'       => 'https://zyreaddons.com/docs/zyre-elementor-addons/widgets/lottie-animation/',
				'title'     => esc_html__( 'Lottie Animation', 'zyre-elementor-addons' ),
