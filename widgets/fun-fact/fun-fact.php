				...
				<?php if ( ! empty( $settings['ff_title'] ) ) : ?>
					<div class="zyre-fun-fact-title-wrap">
						<div class="zyre-fun-fact-title-inner zy-inline-flex zy-align-center zy-gap-1">
							...
							<?php endif; ?>
							<<?php echo zyre_escape_tags( $settings['ff_title_tag'], 'h3' ); ?> <?php $this->print_render_attribute_string( 'ff_title' ); ?>><?php echo zyre_kses_basic( $settings['ff_title'] ); ?></<?php echo zyre_escape_tags( $settings['ff_title_tag'], 'h3' ); ?>>
						</div>
					</div>
				<?php endif; ?>
			</div>
