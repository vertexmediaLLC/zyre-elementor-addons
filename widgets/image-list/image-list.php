...
class Image_List extends Base {

	use List_Item_Advanced_Trait;

	public function get_title() {
		return esc_html__( 'Image List', 'zyre-elementor-addons' );
	}

	public function get_icon() {
		return 'zy-fonticon zy-Image-list';
	}

	public function get_keywords() {
		return [ 'image list', 'images lists', 'image grid', 'lists icons', 'list icon', 'icon list', 'icons lists', 'lists items', 'list item', 'text', 'feature content' ];
	}
	...
	protected function register_content_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Image List Content', 'zyre-elementor-addons' ),
		...
		$this->register_list_item_advanced_content_controls( [ 'id_prefix' => 'image' ] );
	...
	protected function __item_style_controls() {
		...
		$this->register_item_style_controls( [ 'id_prefix' => 'image' ] );
	...
	protected function render() {
		$this->render_items( null, [ 'id_prefix' => 'image' ] );
	}
}
