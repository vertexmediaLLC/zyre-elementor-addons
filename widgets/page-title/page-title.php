...
class Page_Title extends Base {
	...
	public function get_icon() {
		return 'zy-fonticon zy-Page-Title';
	}
	...
	protected function register_content_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Page Title Content', 'zyre-elementor-addons' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'          => [
					'{{WRAPPER}} .zyre-page-title-heading' => '{{VALUE}};',
				],
			]
		);
	 ...
	 */
	private function title_before_after_content_controls( $prefix ) {
		$types = [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-page-title-' . $prefix  => "{$margin_property}: {{SIZE}}{{UNIT}};",
				],
			]
		);
	}
	...
	protected function __before_text_style_controls() {
		$this->start_controls_section(
			'section_page_text_before_style',
			[
		...
		$this->set_style_controls(
			'before_text',
			[
				'selector' => '{{WRAPPER}} .zyre-page-title-text-prefix',
				'controls' => [
					'typography'  => [],
					'text_color'  => [],
					'text_shadow' => [],
	...
	protected function __before_icon_style_controls() {
		$this->start_controls_section(
			'section_page_icon_before_style',
			[
		...
		$this->set_style_controls(
			'before_icon',
			[
				'selector' => '{{WRAPPER}} .zyre-page-title-icon-prefix',
				'controls' => [
					'icon_size'  => [],
					'icon_color' => [],
				],
	...
	protected function __before_separator_style_controls() {
		$this->start_controls_section(
			'section_page_separator_before_style',
			[
		...
		$this->set_style_controls(
			'before_separator',
			[
				'selector' => '{{WRAPPER}} .zyre-page-title-separator-prefix',
				'controls' => [
					'max_width' => [
	...
	protected function __title_style_controls() {
		...
		$this->set_style_controls(
			'title',
			[
				'selector' => '{{WRAPPER}} .zyre-page-title',
				'controls' => [
					'typography' => [],
				],
			]
		...
		$this->set_style_controls(
			'title_hover',
			[
				'selector' => '{{WRAPPER}} .zyre-page-title:hover',
				'controls' => [
					'text_color'  => [],
					'text_shadow' => [],
				],
	...
	protected function __after_text_style_controls() {
		...
		$this->set_style_controls(
			'after_text',
			[
				'selector' => '{{WRAPPER}} .zyre-page-title-text-suffix',
				'controls' => [
					'typography'  => [],
					'text_color'  => [],
					'text_shadow' => [],
	...
	protected function __after_icon_style_controls() {
		...
		$this->set_style_controls(
			'after_icon',
			[
				'selector' => '{{WRAPPER}} .zyre-page-title-icon-suffix',
				'controls' => [
					'icon_size'  => [],
					'icon_color' => [],
				],
	...
	protected function __after_separator_style_controls() {
		$this->start_controls_section(
			'section_page_separator_after_style',
			[
		...
		$this->set_style_controls(
			'after_separator',
			[
				'selector' => '{{WRAPPER}} .zyre-page-title-separator-suffix',
				'controls' => [
					'max_width' => [
						'css_property' => 'max-width',
						'range'        => [
	...
	protected function render() {
		...
		<<?php echo zyre_escape_tags( $settings['page_title_tag'], 'h2' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> class="zyre-page-title-heading zy-flex zy-align-center zy-m-0 zy-lh-1.5">
			<?php
				$this->__render_title_before_after( 'before', 'prefix' );
				$this->__render_title();
				$this->__render_title_before_after( 'after', 'suffix' );
			?> 
		</<?php echo zyre_escape_tags( $settings['page_title_tag'], 'h2' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
		<?php
	}
	...
	protected function __render_title() {
		...
		if ( 'custom' === $settings['link'] || 'default' === $settings['link'] ) {
			$html_tag = 'a';
			$this->add_render_attribute( 'title', 'class', 'zyre-page-title zy-transition zyre-page-title-link' );
	...
	protected function __render_title_before_after( $prefix, $class_base ) {
		...
		if ( 'text' === $settings[ $prefix . '_types' ] && '' !== $settings[ $prefix . '_text' ] ) : ?>
			<span class="zyre-page-title-<?php echo esc_attr( $prefix ); ?> zyre-page-title-text-<?php echo esc_attr( $class_base ); ?>">
				<?php echo esc_html( $settings[ $prefix . '_text' ] ); ?>
			</span>
		<?php endif; ?>
		<?php if ( 'separator' === $settings[ $prefix . '_types' ] ) : ?>
			<span class="zyre-page-title-<?php echo esc_attr( $prefix ); ?> zyre-page-title-separator-<?php echo esc_attr( $class_base ); ?> zy-grow-1 zy-h-0"></span>
		<?php endif; ?>
