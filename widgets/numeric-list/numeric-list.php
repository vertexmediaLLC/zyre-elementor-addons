...
class Numeric_List extends Base {

	use List_Item_Advanced_Trait;

	public function get_title() {
		return esc_html__( 'Numeric List', 'zyre-elementor-addons' );
	}

	public function get_icon() {
		return 'zy-fonticon zy-Number-list';
	}

	public function get_keywords() {
		return [ 'numeric lists', 'number lists', 'lists icons', 'list icon', 'icon list', 'icons lists', 'lists items', 'list item', 'text', 'feature content' ];
	}
	...
	protected function register_content_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Numeric List Content', 'zyre-elementor-addons' ),
		...
		$this->register_list_item_advanced_content_controls( [ 'id_prefix' => 'numeric' ] );
	...
	protected function __general_style_controls() {
		...
		$this->register_general_style_controls( [ 'id_prefix' => 'numeric' ] );
	...
	protected function __item_style_controls() {
		...
		$this->register_item_style_controls( [ 'id_prefix' => 'numeric' ] );
	...
	protected function __content_style_controls() {
		...
		$this->register_content_style_controls( [ 'id_prefix' => 'numeric' ] );
	...
	protected function __item_type_style_controls() {
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Number or Icon', 'zyre-elementor-addons' ),
				'tab'       => Controls_Manager::TAB_STYLE,

			]
		);

		$this->register_item_type_element_style_controls( [ 'id_prefix' => 'numeric' ] );

		$this->end_controls_section();
	}

	protected function render() {
		$this->render_items( null, [ 'id_prefix' => 'numeric' ] );
	}
}
