...
class Archive_Title extends Base {
	...
	protected function render() {
		...
		<<?php Utils::print_validated_html_tag( $settings['archive_title_tag'] ); ?> class="zyre-archive-title-heading zy-flex zy-gap-2 zy-align-center zy-m-0 zy-lh-1.5">
			<?php
			$this->__render_title_before_after( 'before', 'prefix' );
			$this->__render_title( $settings );
			$this->__render_title_before_after( 'after', 'suffix' );
			?>
		</<?php Utils::print_validated_html_tag( $settings['archive_title_tag'] ); ?>>
		<?php
	}
