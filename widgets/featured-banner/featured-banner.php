...
class Featured_Banner extends Base {
	...
	public function get_title() {
		return esc_html__( 'Featured Banner', 'zyre-elementor-addons' );
	}

	public function get_icon() {
		return 'zy-fonticon zy-Featured-banner';
	}
	...
	protected function __media_content_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'            => [
					'{{WRAPPER}} .zyre-ftb-content-wrapper' => '{{VALUE}}',
				],
				'render_type' => 'template',
				'condition' => [
					'media_element!' => 'none',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors_dictionary' => [
					...
					'below'  => 'flex-wrap: wrap;flex-direction: column;',
				],
				'selectors'            => [
					'{{WRAPPER}} .zyre-ftb-content' => '{{VALUE}};',
				],
				'render_type' => 'template',
				'condition' => [
					'button_show!' => 'none',
	...
	protected function __box_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-content-wrapper' => 'min-height: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	protected function __image_style_controls() {
		...
		$this->set_style_controls(
			'image',
			[
				'selector' => '{{WRAPPER}} .zyre-ftb-bg-wrapper',
				'controls' => [
					'min_width'  => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-bg' => 'transform: scale({{SIZE}});',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner' => '--image-transition-duration: {{SIZE}}ms',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .zyre-ftb-bg-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function overlay_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-bg-overlay' => 'mix-blend-mode: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-bg',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner' => '--overlay-transition-duration: {{SIZE}}ms',
				],
			]
		);
	...
	protected function __media_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-media' => 'min-width: {{SIZE}}{{UNIT}};width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-image img' => 'width: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'media_element' => 'image',
					'media_image[url]!' => '',
		...
		$this->set_style_controls(
			'media',
			[
				'selector' => '{{WRAPPER}} .zyre-ftb-image img, {{WRAPPER}} .zyre-ftb-icon',
				'controls' => [
					'icon_size'     => [
						'selector'  => '{{WRAPPER}} .zyre-ftb-icon',
						'range'     => [
							'px'  => [
								'min' => 6,
								'max' => 300,
	...
	protected function __content_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-content-elements' => '{{VALUE}}',
					'{{WRAPPER}} .zyre-ftb-content-elements > *' => '{{VALUE}}',
				],
			]
		);
		...
		// Colors
		$this->add_control(
			'heading_content_colors_style',
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Colors', 'zyre-elementor-addons' ),
				'separator' => 'before',
			]
		);
	...
	protected function content_colors_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-icon, {{WRAPPER}} .zyre-ftb-image img' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'media_element!' => [
						'none',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-subtitle' => 'color: {{VALUE}};border-color: {{VALUE}};',
				],
				'condition' => [
					'subtitle!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-title-prefix' => 'color: {{VALUE}};border-color: {{VALUE}};',
				],
				'condition' => [
					'title_prefix!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-title' => 'color: {{VALUE}};border-color: {{VALUE}};',
				],
				'condition' => [
					'title!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-title-suffix' => 'color: {{VALUE}};border-color: {{VALUE}};',
				],
				'condition' => [
					'title_suffix!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ftb-description' => 'color: {{VALUE}};border-color: {{VALUE}};',
				],
				'condition' => [
					'description!' => '',
				],
		...
		$this->set_style_controls(
			'content_hover',
			[
				'selector' => '{{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-content-wrapper',
				'controls' => [
					'bg_color'   => [],
					'icon_color' => [
						'selector' => '{{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-icon',
						'condition' => [
							'media_element[value]'  => 'icon',
							'selected_icon[value]!' => '',
						],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-icon, {{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-image img' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'media_element!' => [ 'none', '' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-subtitle' => 'color: {{VALUE}};border-color: {{VALUE}};',
				],
				'condition' => [
					'subtitle!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-title-prefix' => 'color: {{VALUE}};border-color: {{VALUE}};',
				],
				'condition' => [
					'title_prefix!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-title' => 'color: {{VALUE}};border-color: {{VALUE}};',
				],
				'condition' => [
					'title!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-title-suffix' => 'color: {{VALUE}};border-color: {{VALUE}};',
				],
				'condition' => [
					'title_suffix!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner:hover .zyre-ftb-description' => 'color: {{VALUE}};border-color: {{VALUE}};',
				],
				'condition' => [
					'description!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner:hover .zyre-button' => 'color: {{VALUE}}; border-color: {{VALUE}};border-color: {{VALUE}};',
					'{{WRAPPER}} .zyre-ft-banner:hover .zyre-button svg' => 'fill: {{VALUE}};',
				],
				'condition' => [
					'button_show!' => 'none',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .zyre-ft-banner' => '--content-transition-duration: {{SIZE}}ms',
				],
			]
		);
	...
	protected function __button_general_style_controls() {
		...
		$this->set_style_controls(
			'dual_button',
			[
				'selector' => '{{WRAPPER}} .zyre-ftb-buttons',
				'controls' => [
					'layout'          => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'            => [
					'{{WRAPPER}} .zyre-ftb-buttons' => '{{VALUE}};',
				],
				'condition'            => [
	...
	private function text_style_controls( string $prefix ) {
		...
		$this->add_control(
			...
			[
				...
				'render_type' => 'template',
				'selectors'   => [
					'{{WRAPPER}} .zyre-ftb-' . $class_base => 'display: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .zyre-ftb-' . $class_base,
			]
		);

		$selectors_values = [
			"{{WRAPPER}} .zyre-ftb-{$class_base}.zyre-d-block" => 'margin-bottom: {{SIZE}}{{UNIT}};',
			"{{WRAPPER}} .zyre-ftb-{$class_base}.zyre-d-table" => 'margin-bottom: {{SIZE}}{{UNIT}};',
			"{{WRAPPER}} .zyre-ftb-{$class_base}:not(.zyre-d-block):not(.zyre-d-table)" => 'margin-right: {{SIZE}}{{UNIT}};',
		];
		...
		if ( 'title_suffix' === $prefix ) {
			$selectors_values = [
				"{{WRAPPER}} .zyre-ftb-{$class_base}.zyre-d-block" => 'margin-top: {{SIZE}}{{UNIT}};',
				"{{WRAPPER}} .zyre-ftb-{$class_base}.zyre-d-table" => 'margin-top: {{SIZE}}{{UNIT}};',
				"{{WRAPPER}} .zyre-ftb-{$class_base}:not(.zyre-d-block):not(.zyre-d-table)" => 'margin-left: {{SIZE}}{{UNIT}};',
			];
		}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'content_wrapper', 'class', 'zyre-ftb-content-wrapper zy-flex zy-flex-wrap zy-overflow-hidden zy-w-100 zy-relative zy-index-1' );
		$this->add_render_attribute( 'content', 'class', 'zyre-ftb-content zy-flex zy-flex-wrap zy-w-100' );
		$this->add_render_attribute( 'title', 'class', 'zyre-ftb-title-text' );
		$this->add_render_attribute( 'title_prefix', 'class', 'zyre-ftb-title-prefix' );
		...
		if ( ! empty( $settings['button_layout'] ) ) {
			$this->add_render_attribute( 'content', 'class', 'zyre-ftb-content-button--' . $settings['button_layout'] );
		}

		if ( 'icon' === $settings['media_element'] ) {
			$this->add_render_attribute( 'media_element', 'class', 'zyre-ftb-icon-wrapper' );
			...
			$this->add_render_attribute( 'media_element', 'class', 'zyre-ftb-image zy-overflow-hidden' );
		}
		...
		<div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
			<?php if ( $show_bg ) : ?>
				<div class="zyre-ftb-bg-wrapper zy-overflow-hidden zy-index-1">
					<div class="zyre-ftb-bg zy-absolute zy-left-0 zy-right-0 zy-top-0 zy-bottom-0 zy-bg-cover zy-bg-no-repeat zy-index-1 zy-bg-50" <?php $this->print_render_attribute_string( 'background_image' ); ?>></div>
					<div class="zyre-ftb-bg-overlay zy-absolute zy-left-0 zy-right-0 zy-top-0 zy-bottom-0 zy-index-2"></div>
				</div>
			<?php endif; ?>
			<?php if ( $show_content || 'none' !== $settings['media_element'] || 'none' !== $settings['button_show'] ) : ?>
				<div <?php $this->print_render_attribute_string( 'content_wrapper' ); ?>>
					...
					<?php elseif ( 'icon' === $settings['media_element'] && ( ! empty( $settings['icon'] ) || ! empty( $settings['selected_icon']['value'] ) ) ) : ?>
						<div <?php $this->print_render_attribute_string( 'media_element' ); ?>>
							<span class="zyre-ftb-icon zy-inline-block zy-lh-1 zy-content-center">
					...
					<div <?php $this->print_render_attribute_string( 'content' ); ?>>
						<?php if ( $show_content ) : ?>
							<div class="zyre-ftb-content-elements">
								...
								<?php if ( ! empty( $settings['description'] ) ) : ?>
									<<?php Utils::print_validated_html_tag( $description_tag ); ?> <?php $this->print_render_attribute_string( 'description' ); ?>>
										<?php echo wp_kses( $settings['description'], zyreladdons_get_allowed_html() ); ?>
						...
						<?php if ( 'none' !== $settings['button_show'] ) : ?>
							<div class="zyre-ftb-buttons zy-flex zy-align-center zy-justify-start">
